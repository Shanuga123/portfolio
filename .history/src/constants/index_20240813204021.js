...
const projects = [
  ...
  },
  {
    name: "ExperimentVox",
    description:
      "A comprehensive travel booking platExperiment Vox is a dynamic website that showcases a wide range of science experiments, providing clear instructions and educational insights. form that allows users to book flights, hotels, and rental cars, and offers curated recommendations for popular destinations.",
    tags: [
      {
        name: "nextjs",
        color: "blue-text-gradient",
