...
const projects = [
  ...
  },
  {
    ...
    name: "TravelMate",
    description:
      "Your travel web app provides real-time navigation and location-based services, offering users an intuitive map experience with interactive features similar to Google Maps.",
    tags: [
      {
        name: "nextjs",
        color: "blue-text-gradient",
