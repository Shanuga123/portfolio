...
const projects = [
  ...
  {
    name: "Ajax Alarm Website",
    description:
      "Web application that that enables real-time product updates without page reloads. The site offers a streamlined interface and efficient filtering for easy alarm system purchases.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
