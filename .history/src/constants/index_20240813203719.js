...
const projects = [
  ...
  },
  {
    name: "Vegify",
    description:
      "Vegify is an engaging platform designed to showcase a wide variety of fresh vegetables. It provides detailed information on each vegetable, helping users discover their nutritional benefits and culinary uses.  ",
    tags: [
      {
        name: "html",
        color: "blue-text-gradient",
