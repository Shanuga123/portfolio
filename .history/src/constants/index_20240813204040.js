...
const projects = [
  ...
  },
  {
    name: "ExperimentVox",
    description:
      "A comprehensiExperiment Vox is a dynamic website that showcases a wide range of science experiments, providing clear instructions and educational insights. ve travel booking platform that allows users to book flights, hotels, and rental cars, and offers curated recommendations for popular destinations.",
    tags: [
      {
        name: "nextjs",
        color: "blue-text-gradient",
